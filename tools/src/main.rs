...
const PAGES: &[Page] = &[
    ...
    Page { slug: "compare1", file: "compare1/compare1", title: "Compare1", order: 5, group: Some("One-Sample Estimators"), heading_offset: -1 },
    // Two-Sample Estimators
    Page { slug: "shift", file: "shift/shift", title: "Shift", order: 6, group: Some("Two-Sample Estimators"), heading_offset: -1 },
    Page { slug: "shift-bounds", file: "shift-bounds/shift-bounds", title: "ShiftBounds", order: 7, group: Some("Two-Sample Estimators"), heading_offset: -1 },
    Page { slug: "ratio", file: "ratio/ratio", title: "Ratio", order: 8, group: Some("Two-Sample Estimators"), heading_offset: -1 },
    Page { slug: "ratio-bounds", file: "ratio-bounds/ratio-bounds", title: "RatioBounds", order: 9, group: Some("Two-Sample Estimators"), heading_offset: -1 },
    Page { slug: "disparity", file: "disparity/disparity", title: "Disparity", order: 10, group: Some("Two-Sample Estimators"), heading_offset: -1 },
    Page { slug: "disparity-bounds", file: "disparity-bounds/disparity-bounds", title: "DisparityBounds", order: 11, group: Some("Two-Sample Estimators"), heading_offset: -1 },
    Page { slug: "compare2", file: "compare2/compare2", title: "Compare2", order: 12, group: Some("Two-Sample Estimators"), heading_offset: -1 },
    // Randomization
    Page { slug: "rng", file: "rng/rng", title: "Rng", order: 13, group: Some("Randomization"), heading_offset: -1 },
    Page { slug: "uniform-float", file: "uniform-float/uniform-float", title: "UniformFloat", order: 14, group: Some("Randomization"), heading_offset: -1 },
    Page { slug: "uniform-int", file: "uniform-int/uniform-int", title: "UniformInt", order: 15, group: Some("Randomization"), heading_offset: -1 },
    Page { slug: "sample", file: "sample/sample", title: "Sample", order: 16, group: Some("Randomization"), heading_offset: -1 },
    Page { slug: "resample", file: "resample/resample", title: "Resample", order: 17, group: Some("Randomization"), heading_offset: -1 },
    Page { slug: "shuffle", file: "shuffle/shuffle", title: "Shuffle", order: 18, group: Some("Randomization"), heading_offset: -1 },
    // Distributions
    Page { slug: "additive", file: "additive/additive", title: "Additive", order: 19, group: Some("Distributions"), heading_offset: -1 },
    Page { slug: "multiplic", file: "multiplic/multiplic", title: "Multiplic", order: 20, group: Some("Distributions"), heading_offset: -1 },
    Page { slug: "exp", file: "exp/exp", title: "Exp", order: 21, group: Some("Distributions"), heading_offset: -1 },
    Page { slug: "power", file: "power/power", title: "Power", order: 22, group: Some("Distributions"), heading_offset: -1 },
    Page { slug: "uniform", file: "uniform/uniform", title: "Uniform", order: 23, group: Some("Distributions"), heading_offset: -1 },
    // Implementations
    Page { slug: "py", file: "implementations/py", title: "Python", order: 24, group: Some("Implementations"), heading_offset: -1 },
    Page { slug: "ts", file: "implementations/ts", title: "TypeScript", order: 25, group: Some("Implementations"), heading_offset: -1 },
    Page { slug: "r", file: "implementations/r", title: "R", order: 26, group: Some("Implementations"), heading_offset: -1 },
    Page { slug: "cs", file: "implementations/cs", title: "C#", order: 27, group: Some("Implementations"), heading_offset: -1 },
    Page { slug: "kt", file: "implementations/kt", title: "Kotlin", order: 28, group: Some("Implementations"), heading_offset: -1 },
    Page { slug: "rs", file: "implementations/rs", title: "Rust", order: 29, group: Some("Implementations"), heading_offset: -1 },
    Page { slug: "go", file: "implementations/go", title: "Go", order: 30, group: Some("Implementations"), heading_offset: -1 },
    // Auxiliary
    Page { slug: "avg-spread", file: "avg-spread/avg-spread", title: "AvgSpread", order: 31, group: Some("Auxiliary"), heading_offset: -1 },
    Page { slug: "avg-spread-bounds", file: "avg-spread-bounds/avg-spread-bounds", title: "AvgSpreadBounds", order: 32, group: Some("Auxiliary"), heading_offset: -1 },
    Page { slug: "median", file: "median/median", title: "Median", order: 33, group: Some("Auxiliary"), heading_offset: -1 },
    Page { slug: "sign-margin", file: "sign-margin/sign-margin", title: "SignMargin", order: 34, group: Some("Auxiliary"), heading_offset: -1 },
    Page { slug: "pairwise-margin", file: "pairwise-margin/pairwise-margin", title: "PairwiseMargin", order: 35, group: Some("Auxiliary"), heading_offset: -1 },
    Page { slug: "signed-rank-margin", file: "signed-rank-margin/signed-rank-margin", title: "SignedRankMargin", order: 36, group: Some("Auxiliary"), heading_offset: -1 },
    // Appendix
    Page { slug: "assumptions", file: "assumptions/assumptions", title: "Assumptions", order: 37, group: Some("Appendix"), heading_offset: 0 },
    Page { slug: "foundations", file: "foundations/foundations", title: "Foundations", order: 38, group: Some("Appendix"), heading_offset: 0 },
    Page { slug: "methodology", file: "methodology/methodology", title: "Methodology", order: 39, group: Some("Appendix"), heading_offset: 0 },
];
