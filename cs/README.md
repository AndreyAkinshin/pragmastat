...
```bash
dotnet add package Pragmastat --version 12.0.0
```

Install from NuGet via Package Manager Console:

```ps1
NuGet\Install-Package Pragmastat -Version 12.0.0
```

Source code: https://github.com/AndreyAkinshin/pragmastat/tree/v12.0.0/cs
