...
```bash
dotnet add package Pragmastat --version 13.0.1
```

Install from NuGet via Package Manager Console:

```ps1
NuGet\Install-Package Pragmastat -Version 13.0.1
```

Source code: https://github.com/AndreyAkinshin/pragmastat/tree/v13.0.1/cs
