...
```bash
dotnet add package Pragmastat --version 11.0.1
```

Install from NuGet via Package Manager Console:

```ps1
NuGet\Install-Package Pragmastat -Version 11.0.1
```

Source code: https://github.com/AndreyAkinshin/pragmastat/tree/v11.0.1/cs
