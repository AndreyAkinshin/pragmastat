/**
 * The exponential this library evaluates, in place of the platform's.
 */
...
const LN2_HI = 6.9314718036912382e-1;
...
export function expFunction(y: number): number {
  ...
  q = q * r + 2.5052071109214447e-8;
  q = q * r + 2.7557263301474753e-7;
  q = q * r + 2.7557319247204789e-6;
  q = q * r + 2.4801587336421322e-5;
  q = q * r + 1.9841269841263304e-4;
  q = q * r + 1.3888888888879082e-3;
  q = q * r + 8.3333333333333332e-3;
