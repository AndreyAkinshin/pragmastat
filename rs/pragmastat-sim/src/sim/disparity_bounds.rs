...
impl Simulation for DisparityBoundsSim {
    ...
    fn create_inputs(
        ...
        for dist in &self.distributions {
            for &n in sample_sizes {
                let min_misrate = min_achievable_misrate_disparity(n, n);
    ...
    fn simulate_row(
        ...
        for i in 0..input.sample_count {
            ...
            let bounds = pragmastat::estimators::raw::disparity_bounds(&x, &y, input.misrate)
