...
```bash
go get github.com/AndreyAkinshin/pragmastat/go/v14@v14.0.1
```

Source code: https://github.com/AndreyAkinshin/pragmastat/tree/v14.0.1/go
...
import (
	...
	pragmastat "github.com/AndreyAkinshin/pragmastat/go/v14"
)
