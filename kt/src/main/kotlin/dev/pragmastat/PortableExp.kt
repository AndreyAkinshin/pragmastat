 ...
 * polynomial supplying a correction below 0.07, so the assembled result stays within one ulp of
 * the correctly rounded exponential while being reproducible everywhere.
 *
