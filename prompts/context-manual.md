...
- @manual/introduction/breaking.md
- @manual/introduction/definitions.md
...
- @manual/tests/ - source of truth for reference test case suites
  - @manual/tests/_motivation.md @manual/tests/_framework.md - methodology behind testing approach
