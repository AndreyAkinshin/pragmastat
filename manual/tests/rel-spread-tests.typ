...
- `demo-1`: $vx = (1, 3, 5, 7, 9)$, expected output: $0.8$ (base case)
- `demo-2`: $vx = (5, 15, 25, 35, 45)$ (= 5 × demo-1), expected output: $0.8$ (scale invariance)
...
Zero and negative values are excluded because $RelSpread$ requires strictly positive samples.
