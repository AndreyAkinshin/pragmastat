...
- `demo-2`: $vx = (1, 2, 3, 4, 5)$, $vy = (3, 4, 5, 6, 7)$, stricter fixture misrate, expected output: $[-5, 1]$
...
- `edge-permissive-misrate`: $vx = (1, 2, 3, 4, 5)$, $vy = (3, 4, 5, 6, 7)$, very loose fixture misrate (very wide bounds)
...
- `edge-duplicates`: $vx = (3, 3, 3, 3, 3)$, $vy = (5, 5, 5, 5, 5)$ (all duplicates, bounds around -2)
...
*Misrate variation* ($n = m = 20$, $vx = (0, 2, 4, ..., 38)$, $vy = (10, 12, 14, ..., 48)$) — 5 tests from a loose achievable fixture misrate down to $10^(-6)$:
...
- `unsorted-negative-unsorted`: $vx = (-1, -5, -3, -2, -4)$, $vy = (-2, -4, -3, -5, -1)$ (negative values unsorted)
