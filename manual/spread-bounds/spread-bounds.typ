...
== SpreadBounds <sec-spread-bounds>
...
#v(0.5em)
$SpreadBounds$ provides distribution-free bounds on the #link(<sec-spread>)[$Spread$] estimate.
...
#include "spread-bounds-algorithm.typ"

#pagebreak()
=== Notes

#include "spread-bounds-notes.typ"

#pagebreak()
=== Tests

#include "spread-bounds-tests.typ"
