...
Functions like #link(<sec-shift-bounds>)[$ShiftBounds$], #link(<sec-spread-bounds>)[$SpreadBounds$], and #link(<sec-pairwise-margin>)[$PairwiseMargin$] compute distribution-free bounds
...
#list(marker: none, tight: true,
  [#link(<sec-center-bounds>)[$CenterBounds(vx, misrate)$] — requires weak symmetry for exact coverage.],
)
...
#list(marker: none, tight: true,
  [#link(<sec-spread>)[`Spread(x)`] — one-sample spread requires sparity.],
