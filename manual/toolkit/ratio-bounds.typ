...
Robust bounds on $Ratio(vx, vy)$ with specified coverage — the multiplicative dual of $ShiftBounds$.
...
This means if $ShiftBounds$ returns $[a, b]$ for the log-transformed samples,
