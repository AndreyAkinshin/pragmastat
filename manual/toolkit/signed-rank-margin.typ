...
#list(marker: none, tight: true,
  ...
  [*Complexity* — exact for $n <= 63$, approximated for larger (see #link(<sec-fast-signed-rank-margin>)[Fast SignedRankMargin])],
...
#v(0.5em)
This is a supporting function that $CenterBounds$ uses internally, so most users do not need to call it directly.
